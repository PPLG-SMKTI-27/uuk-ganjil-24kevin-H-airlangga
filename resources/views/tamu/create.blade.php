...
@section('subtitle', 'Catat pengunjung baru ke sistem')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6 flex items-center space-x-2 text-sm">
        ...
        <span class="text-gray-600">Tambah Tamu</span>
    </div>

    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <!-- Header -->
        <div class="bg-gradient-to-r from-primary-600 to-purple-600 px-8 py-8 text-white">
            <h2 class="text-3xl font-bold mb-2">Form Tambah Tamu Baru</h2>
            <p class="text-blue-100">Catat data pengunjung baru ke sekolah</p>
        </div>
            ...
            <form action="{{ route('tamu.store') }}" method="POST" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="time"
                                       ...
                                       class="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all @error('waktu_masuk') border-red-500 @enderror"
                                       required>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button type="submit" class="flex-1 inline-flex items-center justify-center bg-gradient-to-r from-primary-600 to-purple-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                        <i class="fas fa-save mr-2"></i>Simpan Tamu
                    </button>
                </div>
            </form>
        </div>
